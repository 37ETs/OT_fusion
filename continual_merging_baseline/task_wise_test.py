...
args.logs_path = '/home/ykd/project/model_merging/AdaMerging/taskarithmetic/src/logs/' + model
args.sample_path = "/home/ykd/project/model_merging/AdaMerging/embedding/"
args.ratio = 0.3
args.standard = 0
...
log.info("Model: " + args.model + " Ratio: " + str(args.ratio) + " Standard: " + str(args.standard))
epochs = 500
...
for epoch in range(epochs):
    ...
    for dataset_name in exam_datasets:
        ...
        dataset = get_dataset(dataset_name, pretrained_model.val_preprocess, location=args.data_location, credible_samples = credible_samples, batch_size=16)
    ...
    losses.backward()
    optimizer.step()
    log.info("Epoch: " + str(epoch) + " Loss: " + str(losses))
